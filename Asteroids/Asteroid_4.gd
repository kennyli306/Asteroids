...
var particles_path = preload("res://Asteroids/Asteroid_4_Part.tscn")
...
func _ready():
	...
	if angle_dir < .5: 
		...
		angle_dir = 1
	var angle_speed = angle_dir * rand_range(PI * .5, PI * .75)
...
func destroy():
	Asteroid_4.emit_signal("destroyed")
	...
	for i in range(num_spawn):
		spawn_asteroid_3()
		Asteroid_4.emit_signal("spawned")
